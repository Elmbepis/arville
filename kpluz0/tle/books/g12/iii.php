...
<head>
<meta http-equiv="Contiii-Language" content="en-us">
<meta http-equiv="Contiii-Type" content="text/html; charset=windows-1252">

<?php
echo "<title>Table of Contents - Inquiries, Investigations, and Immersion</title>";
$format=0;
?>
...
echo "<br/><b>Inquiries, Investigations,<br/>and Immersion</b>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><b>First Quarter Topics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=iii-brainstorming&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Brainstorming for Research Topics</a>";
echo "<br/>";
$ref="../page-display.php?file=iii-problem-question&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Identifying the Problem & Question</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Second Quarter Topics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=iii-reading-rel1&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Selection and Citation of Related Literature</a>";
echo "<br/>";
$ref="../page-display.php?file=iii-reading-rel2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Analysis and Review of Related Literature</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Third Quarter Topics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=iii-data-collect&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Understanding Data Collection Methods</a>";
echo "<br/>";
$ref="../page-display.php?file=iii-answering-questions&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Answering the Research Questions</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Fourth Quarter Topics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=iii-conc-recom&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Writing Clear and Effective Reports</a>";
echo "<br/>";
$ref="../page-display.php?file=iii-sharing&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Sharing your Research</a>";
echo "<br/>";
