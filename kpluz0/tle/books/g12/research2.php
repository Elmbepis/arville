...
{ 
	...
	session_start();
	$_SESSION['booknum']="g12/research2.php";
 	require '../../../offset.php';
...
<?php
echo "<title>Table of Contents - Research in Daily Life 2</title>";
$format=0;
?>
...
echo "<br/><b>Research in Daily Life 2</b>";
echo "<br/><br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=r2-quantres&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Nature and Kinds of Quantitative Research</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Importance of Quantitative Research</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-variables&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Kinds of Variables and their Uses</a>";
echo "<br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=r2-qnres-design-life&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Designing a Real-life Research Project</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-topics-range&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Range of Quantitative Research Topics</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-title-bg&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Writing the Research Title and Background</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-questions&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>How to State Research Questions</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-delimitation&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Defining the Study's Scope and Delimitation</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-benefits&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Identifying the Study's Benefits/Beneficiaries</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnres-prob-wstate&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/><br/>";
$ref="../page-display.php?file=r2-lit-select&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/>";
$ref="../page-display.php?file=r2-lit-terms&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Defining the Terms Used in the Study</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-lit-concept-fw&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Developing the Conceptual Framework</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-lit-hypotheses&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Forming Research Hypotheses</a>";
echo "<br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=r2-quanres-design&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Choosing the Quantitative Research Design</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-quanres-sampling&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Sampling for Quantitative Research</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-quanres-datacolan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Quantitative Data Collection and Analysis</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-qnwrm&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Written Quantitative Research Methodology</a>";
echo "<br/>";
...
echo "<br/>";
$ref="../page-display.php?file=r2-datacol-instr&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Collecting Data using Instruments</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-data-tabgra&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Presenting Data in Tables and Graphs</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-stat-data-analy&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Using Statistical Methods to Analyze Data</a>";
echo "<br/>";
...
echo "<br/>";
$ref="../page-display.php?file=r2-best-design&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Presenting Quantitative Research Findings</a>";
echo "<br/>";
$ref="../page-display.php?file=r2-res-workbook&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Presenting the Research Workbook</a>";
echo "<br/>";
