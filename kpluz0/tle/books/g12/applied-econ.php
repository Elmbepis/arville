...
{ 
	...
	session_start();
	$_SESSION['booknum']="g12/applied-econ.php";
 	require '../../../offset.php';
...
<?php
echo "<title>Table of Contents - Applied Economics</title>";
$format=0;
?>
...
echo "<br/><b>Applied Economics</b>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><b>Introduction to<br/>Applied Economics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=ae-econ-ss&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Economics as a Social Science</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-econ-as&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Economics as an Applied Science</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-terms&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Basic Terms in Applied Economics</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-ph-problems&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Basic Economic Problems of the Philippines</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Application of<br/>Supply and Demand</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=ae-supply-demand&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>The Law of Supply and Demand</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-supply-demand-fac&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Factors Affecting Demand and Supply</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-commod-prices&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Prices of Commodities and their Impact</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-market-struc-types&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Different Types of Market Structures</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Contemporary  Economic Issues<br/>Facing the Filipino Entrepreneur</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=ae-contemp-issues&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Effects of Contemporary Issues</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-inv-int&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Investment and Interest Rate</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-rent-wage-taxes&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Rentals, Minimum Wage, and Taxes</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Industry and<br/>Environmental Analysis</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=ae-bus-ptt&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Business Principles, Tools, Techniques</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-prodserv-local&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Services and Products of Local Industries</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-id-opportunities&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Identifying Business Opportunities</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Socioeconomic Impact Study</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=ae-soc-econ-fac&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Socioeconomic Factors in Business/Industry</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-eval-bus-viability&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Evaluating Business Viability and Impact</a>";
echo "<br/>";
$ref="../page-display.php?file=ae-soc-econ-impact&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Conducting Socioeconomic Impact Studies</a>";
echo "<br/>";
