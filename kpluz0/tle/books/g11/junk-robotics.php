...
<?php
echo "<title>Table of Contents - Grade ".$grd." TLE for the ABM Strand</title>";
$format=0;
?>
...
echo "<br/><br/><br/>Grade 11 TLE<br/></b></font>";
?>
...
echo "<br/><b>Introduction to<br/>Junk Robotics</b>";
echo "<br/><br/>";
...
echo "<a href='$ref'>Robotics and its Applications</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>The Concept of Junk Robotics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Importance of Junk Robotics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-char-proc&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Recycled Materials for Junk Robotics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-kinds&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Safety Guidelines for Junk Robotics</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Simple Machines<br/>and Mechanisms</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Basic Mechanical Concepts</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Levers and Lever Mechanics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pulleys and Pulley Mechanics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Gears and Gear Systems</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Wheel and Axle Systems</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Linkages and Joints</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Cams and Cam-driven Systems</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Trade-offs Among Speed, Force, & Distance</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-char-proc&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Building and Testing Mechanisms</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-char-proc&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Using Mechanisms in Junk Robotics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-char-proc&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Kinematic Principles and Robot Movement</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-char-proc&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Prototyping and Iteration</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Introduction to<br/>Electronics</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Circuits and Electronic Components</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Power Sources and Batteries</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Switches and Sensors</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Light Emitting Diodes (LED's)</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Motors and Actuators</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Basic Circuits Used in Robotics</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Breadboarding and Prototyping</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Basic Soldering Techniques</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Building Your<br/>Robot from Junk</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Designing your Junk Robot</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Building your Robot's Mechanical System</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Building your Robot's Electronic System</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Putting Together the Mechatronic System</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Programming<br/>Your Robot</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Introduction to the Arduino Platform</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>The XXX Arduino Board</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Configuring the Arduino Board</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Programming the Arduino Board</a>";
echo "<br/>";
$ref="../page-display.php?file=r1-res-importance&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Controlling Your Robot Using Arduino</a>";
echo "<br/>";
...
Using microcontrollers to process signals and control outputs.
Connecting actuators (motors, servos) and LEDs to circuits.
Troubleshooting and Debugging:

Identifying common circuit issues (short circuits, loose connections).
Debugging techniques to fix circuit problems.
Developing problem-solving skills in electronics.
Electronics Waste and Recycling:

Discussing the importance of responsible electronics disposal.
Exploring e-waste recycling and environmental impact.
*/
