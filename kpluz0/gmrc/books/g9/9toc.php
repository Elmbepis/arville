...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikasiyam na Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=9mapanuri&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mapanuring Pag-iisip: Kamalayan sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=9pasya-matalino&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Matalinong Pagpapasya</a>";
echo "<br/>";
$ref="../page-display.php?file=9responsable&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Responsable</a>";
echo "<br/>";
$ref="../page-display.php?file=9integridad&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagkakaroon ng Integridad</a>";
echo "<br/>";
$ref="../page-display.php?file=9paghuhusga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Maingat na Paghuhusga</a>";
echo "<br/>";
$ref="../page-display.php?file=9katiwala&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mabuting Katiwala</a>";
echo "<br/>";
$ref="../page-display.php?file=9digital-citizen&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutang Digital Citizen</a>";
echo "<br/>";
$ref="../page-display.php?file=9buhay-galang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "Pagiging Mapagpasalamat</a>";
echo "<br/>";
$ref="../page-display.php?file=5maagap2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Pakikiisa sa Pagkalinga sa Kalikasan</a>";
echo "<br/>";
...
echo "Pagtangkilik sa Husay ng mga Pilipino</a>";
echo "<br/>";
