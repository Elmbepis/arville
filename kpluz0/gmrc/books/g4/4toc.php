...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikaapat na Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=4pagpapahalaga-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapahalaga sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=4matapat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matapat</a>";
echo "<br/>";
$ref="../page-display.php?file=4magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang</a>";
echo "<br/>";
$ref="../page-display.php?file=4pananalig&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananalig sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=4mapanagutan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan</a>";
echo "<br/>";
$ref="../page-display.php?file=4pagmamahal-bayan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagmamahal sa Bayan</a>";
echo "<br/>";
$ref="../page-display.php?file=4tiwala-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/><br/>";
$ref="../page-display.php?file=4matipid&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matipid</a>";
echo "<br/>";
$ref="../page-display.php?file=4mapagpasalamat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasalamat</a>";
echo "<br/>";
$ref="../page-display.php?file=4matiyaga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matiyaga</a>";
echo "<br/>";
$ref="../page-display.php?file=4mapagpasensiya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasensiya</a>";
echo "<br/>";
$ref="../page-display.php?file=4masunurin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin</a>";
echo "<br/>";
$ref="../page-display.php?file=4katiwala&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mabuting Katiwala</a>";
echo "<br/>";
$ref="../page-display.php?file=4malasakit&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/><br/>";
$ref="../page-display.php?file=4mapagkumbaba&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagkumbaba</a>";
echo "<br/>";
$ref="../page-display.php?file=4malinis&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Malinis</a>";
echo "<br/>";
$ref="../page-display.php?file=4nasyonalismo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Nasyonalismo: Mga Laro ng Lahi</a>";
echo "<br/>";
$ref="../page-display.php?file=4karunungan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Karunungan</a>";
echo "<br/>";
$ref="../page-display.php?file=4malasakit2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa mga Hayop</a>";
echo "<br/>";
$ref="../page-display.php?file=4nasyonalismo2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Nasyonalismo: Kasaysayan ng mga Lugar</a>";
echo "<br/>";
