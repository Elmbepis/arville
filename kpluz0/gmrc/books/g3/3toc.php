...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikatlong Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=3tiwala-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Tiwala sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=3mapagmalasakit&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paglalaan Para sa Pagmamalasakit</a>";
echo "<br/>";
$ref="../page-display.php?file=3responsable&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Responsable sa Tahanan at Paaralan</a>";
echo "<br/>";
$ref="../page-display.php?file=3pananalig&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananalig sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=3disiplina&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Disiplina sa Pagpapabuti ng Kapaligiran</a>";
echo "<br/>";
$ref="../page-display.php?file=3magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang sa Kapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=3pakikiisa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa mga Gawaing Pantahanan</a>";
echo "<br/>";

echo "<br/><br/><b>Ikalawang Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=3mapagpasensiya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasensiya</a>";
echo "<br/>";
$ref="../page-display.php?file=3paghuhusga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Maingat sa Paghuhusga</a>";
echo "<br/>";
$ref="../page-display.php?file=3totoo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Totoo sa Pamilya</a>";
echo "<br/>";
$ref="../page-display.php?file=3pagkukusa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagkukusa sa mga Gawain</a>";
echo "<br/>";
$ref="../page-display.php?file=3pakikiisa2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa mga Gawaing Panrelihiyon</a>";
echo "<br/>";
$ref="../page-display.php?file=3mapagmalasakit2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kalikasan</a>";
echo "<br/>";
$ref="../page-display.php?file=3masunurin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin</a>";
echo "<br/>";
$ref="../page-display.php?file=3mapagmalasakit3&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=3magalang2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang sa mga PWD</a>";
echo "<br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=3madasalin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Madasalin</a>";
echo "<br/>";
$ref="../page-display.php?file=3masinop&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masinop</a>";
echo "<br/>";
$ref="../page-display.php?file=3bayan-mahal&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagmamahal sa Bayan</a>";
echo "<br/>";
$ref="../page-display.php?file=3pakikiisa3&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=3responsable2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Responsable sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=3pananampalataya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagtugon sa Pananampalataya</a>";
echo "<br/>";
$ref="../page-display.php?file=3mapagpasalamat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
