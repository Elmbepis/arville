...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikalimang Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=5buhay-galang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paggalang sa Buhay</a>";
echo "<br/>";
$ref="../page-display.php?file=5pahalaga-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapahalaga sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=5maagap&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Maagap sa Pag-iimpok</a>";
echo "<br/>";
$ref="../page-display.php?file=5pananampalataya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananampalataya sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=5masinop&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masinop</a>";
echo "<br/>";
$ref="../page-display.php?file=5masunurin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin sa Batas Trapiko</a>";
echo "<br/>";
$ref="../page-display.php?file=5mapagpasalamat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasalamat sa Magulang</a>";
echo "<br/>";
...
echo "<a href='$ref'>Pagiging Mapagpasalamat sa mga OFW</a>";
echo "<br/>";
$ref="../page-display.php?file=5magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang sa Pamilya</a>";
echo "<br/>";
$ref="../page-display.php?file=5mapanagutan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan sa Pamilya</a>";
echo "<br/>";
//integrate pananampalataya with others
$ref="../page-display.php?file=5mapagpasalamat2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasalamat sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=5malinis&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Malinis</a>";
echo "<br/>";
$ref="../page-display.php?file=5nasyonalismo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagtangkilik sa mga Lokal na Produkto</a>";
echo "<br/>";
...
echo "<a href='$ref'>Pagiging Magalang sa mga Nakatatanda</a>";
echo "<br/>";
...
echo "<a href='$ref'>Pananampalataya: Paggalang sa mga Simbolo</a>";
echo "<br/>";
$ref="../page-display.php?file=5maingat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Maingat</a>";
echo "<br/>";
$ref="../page-display.php?file=5maagap2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Maagap sa Oras</a>";
echo "<br/>";
$ref="../page-display.php?file=5magiliw&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magiliw</a>";
echo "<br/>";
$ref="../page-display.php?file=5masunurin2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=5pag-asa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Pag-asa</a>";
echo "<br/>";
$ref="../page-display.php?file=5positibo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Positibo sa Buhay</a>";
echo "<br/>";
$ref="../page-display.php?file=5mapanagutan2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan sa Kalikasan</a>";
echo "<br/>";
$ref="../page-display.php?file=5nasyonalismo2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagkilala sa mga Likhang-Sining</a>";
echo "<br/>";
