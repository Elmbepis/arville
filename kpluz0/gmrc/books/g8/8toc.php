...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikawalong Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=8paghuhusga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Maingat na Paghuhusga</a>";
echo "<br/>";
$ref="../page-display.php?file=8matatag2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matatag sa mga Pagsubok</a>";
echo "<br/>";
$ref="../page-display.php?file=8malasakit&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=8buhay-galang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paggalang sa Sariling Buhay</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagpasalamat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasalamat sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=8payak&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pamumuhay nang Payak</a>";
echo "<br/>";
$ref="../page-display.php?file=8malasakit2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pag-iimpok para Makatulong sa Iba</a>";
echo "<br/>";
$ref="../page-display.php?file=8masipag&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masipag</a>";
echo "<br/>";

echo "<br/><br/><b>Ikalawang Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=8matatag&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagkakaroon ng Positibong Pananaw</a>";
echo "<br/>";
$ref="../page-display.php?file=8matapat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matapat</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagpasalamat2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasalamat sa Pamilya</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagkumbaba&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagkumbaba</a>";
echo "<br/>";
$ref="../page-display.php?file=8pananampalataya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananampalataya sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapamaraan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapamaraan</a>";
echo "<br/>";
$ref="../page-display.php?file=8nasyonalismo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Makasaysayang Pagdiriwang</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagpasensiya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasensiya</a>";
echo "<br/>";
//integrate pananampalataya with others
$ref="../page-display.php?file=8magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang</a>";
echo "<br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=8mapaglingkod&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapaglingkod</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagmalasakit3&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa mga Hayop</a>";
echo "<br/>";
$ref="../page-display.php?file=8pakikiisa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa mga Ibang Lahi</a>";
echo "<br/>";
$ref="../page-display.php?file=8paghuhusga2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paglinang ng Positibong Disposisyon</a>";
echo "<br/>";
$ref="../page-display.php?file=8nasyonalismo2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paggamit ng Kalayaan sa Pagkamapanagutan</a>";
echo "<br/>";
$ref="../page-display.php?file=8patas&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Patas</a>";
echo "<br/>";
$ref="../page-display.php?file=8pakikiisa2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa mga Kapanalig</a>";
echo "<br/>";
$ref="../page-display.php?file=8mapagbigay&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagbigay</a>";
echo "<br/>";
$ref="../page-display.php?file=8buhay-galang2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Paggalang sa mga 'Endangered Species'</a>";
echo "<br/>";
$ref="../page-display.php?file=8pakikiisa3&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa Pagpapanatili ng Kapayapaan</a>";
echo "<br/>";
