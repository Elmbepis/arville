...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikasampung Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=10mapanagutan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapangutan sa mga Gampanin</a>";
echo "<br/>";
$ref="../page-display.php?file=10matiyaga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matiyaga</a>";
echo "<br/>";
$ref="../page-display.php?file=10mapagpasensiya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasensiya</a>";
echo "<br/>";
$ref="../page-display.php?file=10pananampalataya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananampalataya sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=10katiwala&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mabuting Katiwala</a>";
echo "<br/>";
$ref="../page-display.php?file=10makatarungan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Makatarungan at Patas sa Lahat</a>";
echo "<br/>";
$ref="../page-display.php?file=10mapanagutan2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan sa Pagpaplano</a>";
echo "<br/>";
...
echo "Pagiging Makatarungan sa Pakikipagkapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=5pananampalataya2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Pagkakaroon ng Integridad</a>";
echo "<br/>";
...
echo "Pagpapahalaga sa Pamana ng Kultura</a>";
echo "<br/>";
...
echo "Pagiging Mapanagutan sa Pakikipagkapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=5mapanagutan2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Pagiging Mapagmalasakit sa Kalikasan</a>";
echo "<br/>";
$ref="../page-display.php?file=5nasyonalismo2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Pandaigdigang Pag-unawa at Pagkakaisa</a>";
echo "<br/>";
