...
<?php
echo "<title>Table of Contents - Grade ".$grd." AP by KPluz</title>";
$format=0;
?>
...
echo "<br/><br/><br/>GMRC Para<br/>sa Ikapitong Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=7paghuhusga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Maingat na Paghuhusga</a>";
echo "<br/>";
$ref="../page-display.php?file=7magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang</a>";
echo "<br/>";
$ref="../page-display.php?file=7matatag&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matatag</a>";
echo "<br/>";
$ref="../page-display.php?file=7pananalig&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pananalig sa Diyos</a>";
echo "<br/>";
$ref="../page-display.php?file=7katiwala&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mabuting Katiwala</a>";
echo "<br/>";
$ref="../page-display.php?file=7kahandaan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Kahandaan</a>";
echo "<br/>";
$ref="../page-display.php?file=7mapanagutan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan</a>";
echo "<br/>";

echo "<br/><br/><b>Ikalawang Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=7matiyaga&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matiyaga</a>";
echo "<br/>";
$ref="../page-display.php?file=7mapagmahal&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmahal</a>";
echo "<br/>";
$ref="../page-display.php?file=7madasalin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Madasalin</a>";
echo "<br/>";
$ref="../page-display.php?file=7mapagmalasakit&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kapaligiran</a>";
echo "<br/>";
$ref="../page-display.php?file=7nasyonalismo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Nasyonalismo</a>";
echo "<br/>";
$ref="../page-display.php?file=7tiwala-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Tiwala sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=7mapagmalasakit2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=7mapagkumbaba&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagkumbaba</a>";
echo "<br/>";
$ref="../page-display.php?file=7matapat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Tapat at Mabuting Kaibigan</a>";
echo "<br/>";
...
echo "<br/><br/>";
$ref="../page-display.php?file=7matipid&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matipid saTubig at Enerhiya</a>";
echo "<br/>";
$ref="../page-display.php?file=7karunungan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Karunungan</a>";
echo "<br/>";
$ref="../page-display.php?file=7disiplina&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapakita ng Disiplina</a>";
echo "<br/>";
$ref="../page-display.php?file=7malikhain&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Malikhain</a>";
echo "<br/>";
