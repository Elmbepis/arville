...
echo "<br/><br/><br/>GMRC Para sa<br/>Ikalawang Baitang<br/><br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=2pahalaga-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapahalaga sa Sarili</a>";
echo "<br/>";
$ref="../page-display.php?file=2totoo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Totoo sa Sariling Damdamin</a>";
echo "<br/>";
$ref="../page-display.php?file=2madasalin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Madasalin</a>";
echo "<br/>";
$ref="../page-display.php?file=2masinop&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masinop</a>";
echo "<br/>";
$ref="../page-display.php?file=2masunurin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=2tiwala-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/><br/>";
$ref="../page-display.php?file=2mapanagutan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan sa Kapwa</a>";
echo "<br/>";
$ref="../page-display.php?file=2malasakit2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagmamalasakit sa mga Pasilidad</a>";
echo "<br/>";
$ref="../page-display.php?file=2mapagpasensiya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagpasensiya</a>";
echo "<br/>";
$ref="../page-display.php?file=2matapat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matapat</a>";
echo "<br/>";
$ref="../page-display.php?file=2masunurin2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Masunurin sa Pamilya</a>";
echo "<br/>";
$ref="../page-display.php?file=2maayos&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Maayos</a>";
echo "<br/>";
$ref="../page-display.php?file=2pakikitungo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mabuting Pakikitungo sa mga Bisita</a>";
echo "<br/>";
$ref="../page-display.php?file=2mapagmahal&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmahal</a>";
echo "<br/>";
$ref="../page-display.php?file=2mapagpasalamat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "<br/><br/>";
$ref="../page-display.php?file=2magalang&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Magalang sa mga Relihiyon</a>";
echo "<br/>";
$ref="../page-display.php?file=2malasakit&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapagmalasakit sa Kapaligiran</a>";
echo "<br/>";
$ref="../page-display.php?file=2matulungin&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Matulungin</a>";
echo "<br/>";
$ref="../page-display.php?file=2mapanagutan2&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Mapanagutan sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=2palakaibigan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagiging Palakaibigan</a>";
echo "<br/>";
$ref="../page-display.php?file=2pakikiisa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pakikiisa sa mga Gawaing Panrelihiyon</a>";
echo "<br/>";
$ref="../page-display.php?file=2malasakit3&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagmamalasakit sa Pamayanan</a>";
echo "<br/>";
$ref="../page-display.php?file=2bayan-mahal&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
