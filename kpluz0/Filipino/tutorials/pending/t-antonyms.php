																																										...
																																										<div id="static-pages6">
																																											<div class="page-width">
																																												<div id="free-resources6" class="page-right-side">
																																													<div class="page-chunk punctuation">
																																														<div class="page-chunk-pad">
																																															Imagine for a moment how dull the world would be if there were only one word to voice a particular thought. If every person, place, or object could only be expressed with the same word over and over again then reading, writing, and speaking would be extremely boring. Luckily, we have synonyms and antonyms to add spice and flavor to our communication skills.</div>
																																													</div>
																																												</div>
																																											</div>
																																										</div>
																																									</div>
																																									<h2><strong>What are Antonyms?</strong></h2>
																																									<p>Antonyms are words that have opposite meanings. For example, the antonym of long is short. Often words will have more than one antonym but as with synonyms it depends on the context. For instance, the word warm could have the antonym cool or chilly. In order to choose the correct antonym, you have to look at all the meanings and how the word is used. Cool can mean stylish as well as chilly so the word cool may not be the best choice.</p>
																																									<h2><strong>Types of Antonyms</strong></h2>
																																									<p>Antonyms fall within the three categories: graded antonyms, relational antonyms, and complementary antonyms.</p>
																																									<p><strong>Graded antonyms</strong> are word pairs that have variations between the two opposites. For example, big and little are antonyms but there are a lot of changes before you get to the opposite meaning. Like this:</p>
																																									<p>Big, huge, bulky, full-size, slight, petite, little</p>
																																									<p>Other examples are:</p>
																																									<p>Happy – sad</p>
																																									<p>Healthy – sick</p>
																																									<p>Smart – stupid</p>
																																									<p><strong>Relational antonyms</strong> are pairs that have a relationship. Each word wouldn’t exist without the other. There can’t be a parent without a child or it’s either all or nothing. Other examples include:</p>
																																									<p>Open – close</p>
																																									<p>Husband – wife</p>
																																									<p>Front – back</p>
																																									<p>Hello – goodbye</p>
																																									<p><strong>Complimentary antonyms</strong> are word pairs that have no degree of meaning. There are only two opposite possibilities.</p>
																																									<p>Dead- alive</p>
																																									<p>True – false</p>
																																									<p>Male- female</p>
																																									<p>Daughter – son</p>
																																									<p>On – off</p>
																																									<p>When using antonyms always keep in mind the context of the word and then choose the best word that means the opposite. As with synonyms, showing variations in meaning through the use of the correct antonyms will add spark and interest to your writing. If you haven’t already, get to know your Thesaurus. It could be your new best friend!</div>
																																							</div>
																																						</div>
																																					</div>
																																				</div>
