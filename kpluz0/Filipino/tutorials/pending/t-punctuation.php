																																					...
																																					<div class="page-width">
																																						<div id="free-resources5" class="page-right-side">
																																							<div class="page-chunk punctuation">
																																								<div class="page-chunk-pad">
																																									<h1>Punctuation Marks</h1>
																																									<p>&nbsp;</p>
																																									<p>Punctuation marks are important in both written and spoken English. In written English, the correct usage of these symbols helps to express the intended meaning of the sentence. In spoken English, punctuation marks denote the pauses and intonations to be used when reading aloud.</p>
																																									<p>Incorrect punctuation can change the meaning of a sentence.</p>
																																									<p>For instance, compare the following two sentences:</p>
																																									<p>Let’s eat Mom.</p>
																																									<p>Let’s eat, Mom.</p>
																																									<p>Do you see how the usage of a comma changes the entire meaning in both the sentences? The disappearance of comma in the first sentence indicates that the speaker is asking to eat their Mom, which does not make sense. Whereas, the comma after let’s eat in the second sentence helps to convey the meaning that the speaker is suggesting to their Mom to go and start eating, which sounds more sensible and also saves a life.</p>
																																									<p>&nbsp;</p>
																																									<h2><strong>Symbols of Punctuation</strong></h2>
																																									<p>Some of the commonly used punctuation marks are:</p>
																																									<p><a href="http://www.englishleap.com/punctuation/full-stop">Full Stop </a>- (.) Usually used at the end of a sentence.</p>
																																									<p><a href="http://www.englishleap.com/punctuation/question-mark">Question Mark </a>- (?) Usually used at the end of an interrogative sentence to form a question.</p>
																																									<p><a href="http://www.englishleap.com/punctuation/comma">Comma</a> - (,) Usually used to denote a pause in a sentence.</p>
																																									<p><a href="http://www.englishleap.com/punctuation/exclamation-mark">Exclamation Mark</a> - (!) Used to denote shock, surprise, anger or a raised voice.</p>
																																									<p><a href="http://www.englishleap.com/punctuation/colon-semi-colon">Colon</a> – (:) Used to indicate what is to follow next</p>
																																									<p><a href="http://www.englishleap.com/punctuation/colon-semi-colon">Semi Colon</a> (;) Used to link two independent clauses not joined by a conjunction or used to separate two independent clauses in place of comma</p>
																																									<p><a href="http://www.englishleap.com/punctuation/apostrophe">Apostrophe</a> - (') Used to show possession or for contraction of word.</p>
																																									<p>&nbsp;</p>
																																									<p>&nbsp;</div>
																																							</div>
																																						</div>
