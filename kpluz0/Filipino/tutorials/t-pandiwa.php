...
<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
											<font face="Arial" style="font-size: 13pt" color="#333333">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	...
																	pandiwa</font><font face="Arial" style="font-size: 13pt" color="#333333"> 
																	ay isang 
																	bahagi ng 
																	pananalitang 
																	nagsasaad ng 
											...
											<p style="margin-left: 55px; margin-right: 50px; margin-top: 0; margin-bottom: 0" align="center">
																	...
																	Tumakbo</font><font face="Arial" style="font-size: 14pt" color="#000080"> 
																	si Eddie sa 
																	tindahan 
																	upang </font>
																	<font face="Arial" style="font-size: 14pt" color="#990000"> 
																	bumili</font><font face="Arial" style="font-size: 14pt" color="#000080"> 
																	ng mantika.</font></p>
													</td>
												</tr>
												<tr>
...
<img border="0" src="images/note-bottom.jpg"></font></td>
											...
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	...
																	<font face="Arial" style="font-size: 13pt" color="#990000">
																	&#39;tumakbo&#39;</font><font face="Arial" style="font-size: 13pt" color="#333333"> 
																	at </font>
																	<font face="Arial" style="font-size: 13pt" color="#990000">
																	'bumili&#39;</font><font face="Arial" style="font-size: 13pt" color="#333333">
																	ay mga 
																	pandiwa 
																	dahil 
																	isinasaad ng 
											...
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	...
																	<font face="Arial" style="font-size: 13pt" color="#990000">
																	panlaping 
																	makadiwa</font><font face="Arial" style="font-size: 13pt" color="#333333">.</font></p>
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	<font face="Arial" style="font-size: 13pt" color="#333333">&nbsp;
																	</font></p>
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
											...
											<div align="left">
												<table border="0" width="60%" cellspacing="0" cellpadding="0" style="border: 1px solid #CCCCCC; margin-left: 120">
													<tr>
														<td width="154" bordercolor="#CCCCCC" style="border: 1px solid #C0C0C0">
														...
														<td width="144" bordercolor="#CCCCCC" style="border: 1px solid #C0C0C0">
														<p style="margin-left: 5px; margin-top: 2px; margin-bottom: 2px">
														<font face="Arial" color="#800080" style="font-size: 12pt; font-weight: 700">
														Panlapi</font></td>
													...
													<tr>
														...
														<td bordercolor="#CCCCCC" style="border: 1px solid #C0C0C0">
														<p style="margin-left: 5px; margin-top: 2px; margin-bottom: 2px">
														<font face="Arial" color="#990000" style="font-size: 12pt">
														nag-aral</font></td>
													</tr>
													<tr>
														<td width="154" bordercolor="#CCCCCC" style="border: 1px solid #C0C0C0">
