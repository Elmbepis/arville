						...
						<div align="center">
							<table border="0" width="613" cellspacing="0" cellpadding="0" id="table97">
								<tr>
									...
									<p style="margin-top: 45px; margin-bottom: 20px">
									<img border="0" src="images/note-talasalitaan.jpg" width="247" height="117"></td>
								</tr>
								<tr>
									<td width="204" align="center">
									<p style="margin-top:0; margin-bottom:20px">
											<a href="t-vocpics.php">
											<img border="0" id="vocpics-home23"  src="images/vocpicsa.jpg"  onmouseover="FP_swapImg(1,0,/*id*/'vocpics-home23', /*url*/'images/vocpicsb.jpg')"   onmouseout="FP_swapImg(0,0,/*id*/'vocpics-home23', /*url*/'images/vocpicsa.jpg')"></a></td>
									<td width="204" align="center">
									<p style="margin-top: 0; margin-bottom: 20px">
											<a href="t-magkasingkahulugan.php">
