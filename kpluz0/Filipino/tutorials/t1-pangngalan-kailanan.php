...
<title>Kailanan ng Pangngalan - Filipino sa KPluz.com</title>
							...
							<tr>
								...
								<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table110">
									<tr>
										...
										Kailanan ng Pangngalan</font></span>
										<div align="center">
...
<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
											...
											<span style="font-size: 13pt">&nbsp;
																	...
																	kailanan</font><font face="Arial" style="font-size: 16pt" color="#333333"> 
																	ng isang 
																	pangalan ang 
																	nagpapahayag 
																	ng 
								...
								Isahan</font></span><p align="justify" style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom:0">
											<font face="Arial" style="font-size: 18pt" color="#0000CC">&nbsp;&nbsp;
											</font></p>
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	<font face="Arial" style="font-size: 16pt" color="#333333">
																	...
																	<font face="Arial" style="font-size: 16pt" color="#990000">
																	isahan </font><font face="Arial" style="font-size: 16pt" color="#333333">
																	kung isa 
																	lamang ang 
																	bilang ng 
																	tao, bagay, 
											...
											<font face="Arial" style="font-size: 13pt">&nbsp;&nbsp;
												...
												<table border="0" width="600" cellspacing="0" cellpadding="0" style="border-width:0px; border-style:solid; margin-left:0">
													<tr>
														...
														<img border="0" src="../images/bokabularyo/bola.jpg" width="159" height="160" style="border: 1px solid #C0C0C0"></td>
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
								...
								<span style="font-weight: 700">
								<font face="Arial" style="font-size: 18pt" color="#0000CC">
								Dalawahan</font></span><p align="justify" style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom:0">
											<font face="Arial" style="font-size: 18pt" color="#0000CC">&nbsp;&nbsp;
											</font></p>
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	<font face="Arial" style="font-size: 16pt" color="#333333">
																	...
																	<font face="Arial" style="font-size: 16pt" color="#990000">
																	dalawahan </font><font face="Arial" style="font-size: 16pt" color="#333333">
																	kung dalawa 
																	ang bilang 
																	ng 
																	tao, bagay, 
											...
											<font face="Arial" style="font-size: 13pt">&nbsp;&nbsp;
												...
												<table border="0" width="600" cellspacing="0" cellpadding="0" style="border-width:0px; border-style:solid; margin-left:0">
													<tr>
														...
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
														<img border="0" src="../images/bokabularyo/mag-ina.jpg" style="border: 1px solid #C0C0C0" width="160" height="160"></td>
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
														<img border="0" src="../images/bokabularyo/mag-asawa.jpg" width="160" height="160" style="border: 1px solid #C0C0C0"></td>
													</tr>
													<tr>
														<td width="222" align="center">
														<p style="margin-left: 10px; margin-right: 10px; margin-bottom: 5px" align="center">
														...
														<span style="font-weight: 700">
														<font face="Arial" style="font-size: 17pt" color="#800080">
														mag-ina</font></span></td>
														<td width="222">
														<p style="margin-left: 10px; margin-right: 10px; margin-bottom: 5px" align="center">
														<span style="font-weight: 700">
														<font face="Arial" style="font-size: 17pt" color="#800080">
														mag-asawa</font></span></td>
													</tr>
													</table>
												<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
											<font face="Arial" style="font-size: 13pt">
											...
											<span style="font-weight: 700">
											<font face="Arial" style="font-size: 18pt" color="#0000CC">
											Maramihan</font></span><p align="justify" style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom:0">
											<font face="Arial" style="font-size: 18pt" color="#0000CC">&nbsp;&nbsp;
											</font></p>
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
																	<font face="Arial" style="font-size: 16pt" color="#333333">
																	...
																	<font face="Arial" style="font-size: 16pt" color="#990000">
																	maramihan</font><font face="Arial" style="font-size: 16pt" color="#333333">
																	kung higit 
																	sa dalawa 
																	ang bilang 
																	ng 
											...
											<font face="Arial" style="font-size: 13pt">&nbsp;&nbsp;
												...
												<table border="0" width="600" cellspacing="0" cellpadding="0" style="border-width:0px; border-style:solid; margin-left:0">
													<tr>
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
														<img border="0" src="../images/bokabularyo/mag-aama.jpg" width="160" height="160" style="border: 1px solid #C0C0C0"></td>
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
														<img border="0" src="../images/bokabularyo/magkakaibigan.jpg" style="border: 1px solid #C0C0C0" width="160" height="160"></td>
														<td width="222" align="center" valign="bottom">
														<p style="margin-bottom: 5px">
														<img border="0" src="../images/bokabularyo/magkakaklase.jpg" width="160" height="160" style="border: 1px solid #C0C0C0"></td>
													</tr>
													<tr>
														<td width="222" align="center">
														...
														<span style="font-weight: 700">
														<font face="Arial" style="font-size: 17pt" color="#800080">
														mag-aama</font></span></td>
														<td width="222" align="center">
														<p style="margin-left: 5px; margin-right: 5px; margin-bottom: 5px" align="center">
														<span style="font-weight: 700">
														<font face="Arial" style="font-size: 17pt" color="#800080">
														magkakaibigan</font></span></td>
														<td width="222">
														<p align="center" style="margin-left: 5px; margin-right: 5px; margin-bottom: 5px">
														<span style="font-weight: 700">
														<font face="Arial" style="font-size: 17pt" color="#800080">
														magkakaklase</font></span></td>
													</tr>
													</table>
												<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 0" align="justify">
											<font face="Arial" style="font-size: 13pt">
											...
											<p style="margin-left: 80px; margin-right: 80px; margin-top: 0; margin-bottom: 10px">
												...
												<table border="0" width="560" cellspacing="0" cellpadding="0" style="border:1px solid #C0C0C0; margin-left:0">
													...
													<tr>
														...
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakamag-anak</font></td>
													</tr>
													<tr>
														<td width="186" style="border: 1px solid #C0C0C0" align="center">
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakagrupo</font></td>
														<td width="186" style="border: 1px solid #C0C0C0" align="center">
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakaklase</font></td>
														<td width="186" style="border: 1px solid #C0C0C0" align="center">
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakalaro</font></td>
													...
													<tr>
														...
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakaopisina</font></td>
														<td width="186" style="border: 1px solid #C0C0C0" align="center">
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														magkakakampi</font></td>
														<td width="186" style="border: 1px solid #C0C0C0" align="center">
														<p style="margin-top: 3px; margin-bottom: 3px">
														<font face="Arial" style="font-size: 16pt" color="#333333">
														Jun, Fe, at Roy</font></td>
													</tr>
													</table>
											<table border="0" width="560" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#C0C0C0; margin-left:0">
													</table>
