						...
						<div align="center">
							<table border="0" width="613" cellspacing="0" cellpadding="0" id="table97">
								...
								<tr>
									...
									<td width="204" align="center">
									<p style="margin-top: 0; margin-bottom: 20px">
											<a href="../../English/tutorials/t1-vocpics-dining-room.php">
											&nbsp;</a><a href="t1-magkasingkahulugan.php"><img border="0" id="synonyms-home25"  src="images/synonymsa.jpg"  onmouseover="FP_swapImg(1,0,/*id*/'synonyms-home25', /*url*/'images/synonymsb.jpg')"   onmouseout="FP_swapImg(0,0,/*id*/'synonyms-home25', /*url*/'images/synonymsa.jpg')"></a></td>
									<td width="205" align="center">
									<p style="margin-top: 0; margin-bottom: 20px">
