...
<?php
echo "<title>Table of Contents - Matatag Grade 7 Filipino</title>";
$format=0;
?>
...
echo "<br/><br/><br/>Grade 7 Filipino<br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=7katutubo-tula&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mga Tula sa Panahon ng Katutubo</a>";
echo "<br/>";
$ref="../page-display.php?file=7ekspositori&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Ekspositori</a>";
echo "<br/>";
$ref="../page-display.php?file=7ekspositori-halimbawa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mga Halimbawa ng Tekstong Ekspositori</a>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Ikalawang Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=7katutubo-tuluyan&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mga Tuluyan sa Panahon ng Katutubo</a>";
echo "<br/>";
$ref="../page-display.php?file=7tuluyan-elemento&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mga Elemento ng Tuluyan</a>";
echo "<br/>";
$ref="../page-display.php?file=7ekspositori-unawa-akad&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Akademikong Pag-unawa sa Ekspositori</a>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Ikatlong Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=7panitikan-espanya&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Panitikan sa Panahon ng Espanya</a>";
echo "<br/>";
$ref="../page-display.php?file=7panitikan-elemento&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagsusuri ng mga Elemento ng Panitikan</a>";
echo "<br/>";
$ref="../page-display.php?file=7balita&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Pampahayagan</a>";
echo "<br/>";
