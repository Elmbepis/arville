...
<?php
echo "<title>Table of Contents - Matatag Grade 8 Filipino</title>";
$format=0;
?>
...
echo "<br/><br/><br/>Grade 8 Filipino<br/><br/></b></font>";
?>
...
echo "<br/><br/>";
$ref="../page-display.php?file=8panitikan-espanya&format=".$format;
...
echo "Panitikan sa Panahon ng Himagsikan</a>";
echo "<br/>";
$ref="../page-display.php?file=8persuweysib&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
...
echo "Ang Tekstong Biswal</a>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Ikalawang Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=8panitikan-amerikano&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Panitikan sa Panahon ng mga Amerikano</a>";
echo "<br/>";
$ref="../page-display.php?file=8multimodal&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Ang Tekstong Multimodal</a>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Ikatlong Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=8panitikan-hapon&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Panitikan sa Panahon ng mga Hapon</a>";
echo "<br/>";
$ref="../page-display.php?file=7ekspositori&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Ang Tekstong Ekspositori</a>";
echo "<br/>";
$ref="../page-display.php?file=7ekspositori&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "Ang Tekstong Pampahayagan</a>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$bluemid'>";}
else{echo "<font face='Arial' style='$bluesmall'>";}
echo "<br/><b>Ikaapat na Markahan</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=8florante-laura&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Kasaysayan ng 'Florante at Laura'</a>";
echo "<br/>";
