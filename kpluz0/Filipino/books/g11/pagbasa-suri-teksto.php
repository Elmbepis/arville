...
{ 
	...
	session_start();
	$_SESSION['booknum']="g11/pagbasa-suri-teksto.php";
 	require '../../../offset.php';
...
<?php
echo "<title>Table of Contents - Pagbasa at Pagsusuri ng Iba't Ibang Teksto Tungo sa Pananaliksik</title>";
$format=0;
?>
...
echo "<br/><br/><br/>Grade 11 Filipino<br/><br/></b></font>";
?>
...
echo "<br/><b>Pagbasa at Pagsusuri<br/>ng Iba't Ibang Teksto<br/>Tungo sa Pananaliksik</b>";
echo "<br/><br/>";
if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><b>Mga Uri ng Teksto</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=bst-impormatibo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Impormatibo</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-deskriptibo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Deskriptibo</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-persuweysib&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Persuweysib</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-naratibo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Naratibo</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-argumentatibo&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ag Tekstong Argumentatibo</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-prosidyural&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Ang Tekstong Prosidyural</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Pagbasa at Pagsusuri<br/>ng Iba't Ibang Teksto</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=bst-ugnay-sarili&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pag-uugnay ng Binasa sa Sarili, Atbp.</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-paliwanag-binasa&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagpapaliwanag ng mga Kaisipang Binasa</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-reak-papel&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagsulat ng Reaksyong Papel</a>";
echo "<br/>";

if ($format!=1){echo "<font face='Arial' style='$blackmid2'>";}
else{echo "<font face='Arial' style='$blacksmall2'>";}
echo "<br/><br/><b>Pagsulat ng Pananaliksik</b>";
echo "<br/><br/>";
$ref="../page-display.php?file=bst-pananaliksik-konsepto&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Mga Konseptong Kaugnay ng Pananaliksik</a>";
echo "<br/>";
$ref="../page-display.php?file=bst-pananaliksik-pagsulat&format=".$format;
if ($format!=1){echo "<font face='Arial' style='$blackmid'>";}
else{echo "<font face='Arial' style='$blacksmall'>";}
echo "<a href='$ref'>Pagsasagawa at Pagsulat ng Pananaliksik</a>";
echo "<br/>";
