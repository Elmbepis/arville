...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --register-tab-text: #E3F2FD; /* Change this to any color you want! */
        }
        ...
        * {
        ...
        .form-tab-simple:first-child {
            border-radius: 13px 0 0 13px;
        }
        
        .form-tab-simple:last-child {
            border-radius: 0 13px 13px 0;
        }
        
        /* Login Tab */
        .form-tab-simple[data-form="login"].active {
            background: var(--login-tab-bg);
            color: var(--login-tab-text);
        }
        
        /* Register Tab */
        .form-tab-simple[data-form="register"].active {
            background: var(--register-tab-bg);
            color: var(--register-tab-text);
        }
        
        /* Hover Effects */
        .form-tab-simple:hover:not(.active) {
            background: #E3F2FD;
            color: #4A90E2;
        }
        ...
        /* Register Button - SIMPLE FIX */
        #registerButton {
            background: var(--register-tab-bg) !important;
            color: var(--register-tab-text) !important;
...
<body>
    ...
    <div class="narrow-form-container">
        ...
        <div class="main-card">
            ...
            <!-- SIMPLE FORM SWITCHER -->
            <div class="form-switcher-simple">
                <div class="form-tab-simple <?php echo $isLogin ? 'active' : ''; ?>" data-form="login" id="loginTab">
                    <i class="fas fa-sign-in-alt"></i> <span>Login</span>
                </div>
                <div class="form-tab-simple <?php echo !$isLogin ? 'active' : ''; ?>" data-form="register" id="registerTab">
...
<button type="submit" name="login" class="btn btn-primary btn-login" style="width: 50% !important; max-width: 250px !important; margin: 0 auto !important; display: block !important;">
    <i class="fas fa-sign-in-alt"></i> Login
            ...
            <form method="POST" action="login.php" class="form-content <?php echo !$isLogin ? 'active' : ''; ?>" id="registerForm">
                ...
                <!-- SIMPLE REGISTER BUTTON WITH ID -->
                <button type="submit" name="register" class="btn" id="registerButton">
    ...
    <script>
        // DOM Elements
        const formTabs = document.querySelectorAll('.form-tab-simple');
        ...
        if (urlParams.get('action') === 'register') {
            document.querySelector('.form-tab-simple[data-form="register"]').click();
        }
