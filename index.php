...
$smallCategories = [
    ...
    ["title" => "Raptor Island 1 (Jurassic)", "tagline" => "Where dinosaurs from the Jurassic Period roam once again", "icon" => "raptor2a.jpg", "hoverIcon" => "raptor2b.jpg", "link" => "nature.htm?id=10"],
    ["title" => "Raptor Island 2 (Cretaceous)", "tagline" => "Where dinosaurs from the Cretaceous Period roam once again", "icon" => "raptor1a.jpg", "hoverIcon" => "raptor1b.jpg", "link" => "nature.htm?id=11"],
