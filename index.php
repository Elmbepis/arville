...
$smallCategories = [
    ...
    ["title" => "Culinary Alley", "tagline" => "Where yummy delights satisfy the cravings of every certified foodie", "icon" => "restosa.jpg", "hoverIcon" => "restosb.jpg", "link" => "village2.htm?id=3"],
