...
$smallCategories = [
    ...
    ["title" => "Junk Food Junction", "tagline" => "A flavor-packed detour where indulgence wins and nutrition loses", "icon" => "junk-fooda.jpg", "hoverIcon" => "junk-foodb.jpg", "link" => "village2.htm?id=15"],
    ...
    ["title" => "Healthy Food Haven", "tagline" => "A nourishing destination where wellness wins while flavor thrives", "icon" => "healthy-fooda.jpg", "hoverIcon" => "healthy-foodb.jpg", "link" => "village2.htm?id=16"],
